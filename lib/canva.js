...
`;
    ...
    font.load().then(function () {
        ...
        imageObj.src = "./happy-pongal-wish-en.png";
    });
} else if (getTamil == "ta") {
    const getInput = searchParams.get("name") || "Your Name";
    const random_id = Math.floor(1000 + Math.random() * 9000);
...
`;
    ...
    font.load().then(function () {
        ...
        imageObj.setAttribute("crossOrigin", "anonymous");
        imageObj.src = "./happy-pongal-wish-ta.png";
    });
} else {
    const ogImg =
  ...
  >
    <div>
      <h3 class="text-3xl font-bold text-indigo-600">இனிய பொங்கல் திருநாள் நல்வாழ்த்துக்கள் 🎊</h3>
      <div class="mt-4 border-t-2 border-indigo-100 pt-2">
        <p class="text-sm font-medium uppercase tracking-widest text-gray-500">
          <br>2024 - Happy <b>பொங்கல்</b> Greeting Wishes image with Name Happy Pongal Greeting image Generator in Tamil and English.
          <br>
          <br>
          இனிய பொங்கல்<br>
      ...
      <img class="w-80" src="/happy-pongal-wish-1469.png" alt="Happy Pongal" loading="lazy">
      </div>
      ...
      <img class="w-80" src="/happy-pongal-wish-2301.png" alt="Happy Pongal" loading="lazy">
      </div>
      <div class="px-6 py-4 font-bold flex items-center justify-center">
