...
`;
    ...
    window.addEventListener('DOMContentLoaded', event => {
        ...
        if (clipboardBtn) {
            clipboardBtn.addEventListener('click', function () {
                const text = `https://pongal.tamilwords.net/?en=en&name=${pageCatch}`;
    ...
    font.load().then(function () {
        ...
        imageObj.onload = function () {
            ...
            context.fillStyle = '#B53471';
            context.fillText(word, 525, 125);
            ...
            if (word == 'Your Name') {
                ...
                <br><div class="flex flex-wrap mt-4 mb-8 items-center justify-center" style="overflow: auto;" role="group"></div><hr class="h-px my-8 bg-green-500 border-0" />`;
            } else {
                document.getElementById('result').innerHTML = `
        <br><div class="flex items-center justify-center"><a class="inline-block px-10 py-3 rounded text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-bold rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 font-medium uppercase" href="${image}" download="${basename}">⬇ Download image</a></div><hr class="h-px my-8 bg-green-500 border-0" />
        `;
            }
        };

        imageObj.setAttribute('crossOrigin', 'anonymous');
        imageObj.src = './happy-pongal-kavithai-images-2.png';
    });
} else if (getTamil == 'ta') {
    const getInput = searchParams.get('name') || 'Your Name';
    const random_id = Math.floor(1000 + Math.random() * 9000);
...
`;
    ...
    window.addEventListener('DOMContentLoaded', event => {
        ...
        if (clipboardBtn) {
            clipboardBtn.addEventListener('click', function () {
                const text = `https://pongal.tamilwords.net/?ta=ta&name=${pageCatch}`;
                navigator.clipboard.writeText(text);
                Toastify({
                    text: 'URL Copied',
                    duration: 2500,
    ...
    font.load().then(function () {
        ...
        imageObj.setAttribute('crossOrigin', 'anonymous');
        imageObj.src = './happy-pongal-kavithai-images-1.png';
    });
} else {
    document.getElementById('content-hide').style.display = 'none';
    document.getElementById('dw-share').style.display = 'none';
    ...
    <div>
      ...
      <div class="mt-4 border-t-2 border-indigo-100 pt-2">
        <p class="text-sm font-medium uppercase tracking-widest text-gray-500">
          <br>2025 - Happy <b>பொங்கல்</b> Greeting Wishes image with Name Happy Pongal Greeting image Generator in Tamil and English. <br><br> Pongal Wishes in Tamil and Pongal Wishes in English.
          <br>
          <br>
          <hr>
          <br>
      ...
      <img class="w-80" src="/happy-pongal-wishes-greeting-quotes-2025.png" alt="Pongal Wishes in Tamil" loading="lazy">
      </div>
      <div class="px-6 py-4 font-bold flex items-center justify-center">
      <a target="_blank" rel="nofollow noopener" href="https://tamilsms.blog/happy-pongal-kavithai-in-tamil/" class="px-5 py-2 text-sm text-white bg-fuchsia-900 rounded-full" data-umami-event="pongal site">பொங்கல் கவிதைகள்</a>
      </div>
      <div class="flex items-center justify-center mt-4 border-t-2 border-indigo-100 pt-6">
      <img class="w-80" src="/happy-pongal-wish-7480.png" alt="Happy Pongal" loading="lazy">
      </div>
      <div class="px-6 py-4 font-bold flex items-center justify-center">
      <a href="/?en=en&name=Your-Name" class="px-5 py-2 text-sm text-white bg-fuchsia-500 rounded-full" data-umami-event="english">Create Now</a>
      </div>
      <div class="flex items-center justify-center mt-4 pt-2">
      <img class="w-80" src="/pongal-wishes-in-tamil.png" alt="Happy Pongal" loading="lazy">
      </div>
      <div class="px-6 py-4 font-bold flex items-center justify-center">
      <a href="/?ta=ta&name=Your-Name" class="px-5 py-2 text-sm text-white bg-sky-600 rounded-full" data-umami-event="tamil">Create Now</a>
      </div>
    </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-300">
                        <tr class="whitespace-nowrap odd:bg-gray-100 hover:!bg-stone-200">
                            <td class="bg-emerald-100 px-6 py-8 font-bold text-sm">
                             ...
                             <p class="text-purple-900">➡ 2025 Pongal Wishes Tamil</p>
                             <p class="text-purple-900">➡ 2025 Pongal Wishes Greetings in Tamil and English</p>
                            </td>
                        </tr>
                    </tbody>
                </table>
